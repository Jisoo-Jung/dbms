...
/*
 ...
 ' * -> 전체 컬럼 , 근데 이슈 있어서 실무에서 쓰지 않음. '
 설명 달아주는 것 자꾸 연습하기
 처음에는 커리문 치고 그 위에 설명문 쓰는 것 연습하기
...
SELECT ID, NAME, COLOR, PRICE FROM TBL_FLOWER;

INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, 'Jangmi', 'Red', 1000);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, 'Hebaragy', 'Yellow', 2000);
INSERT INTO TBl_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, 'Mindlerae', 'Yellow', 1000);

SELECT ID, NAME, COLOR, PRICE FROM TBL_FLOWER;

INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, 'Guckhwa', 'White', 1200);
...
INSERT INTO TBL_FLOWER 
VALUES(SEQ_FLOWER.NEXTVAL, '민들레', '노란색', 1000);
...
INSERT INTO TBL_FLOWER 
VALUES(SEQ_FLOWER.NEXTVAL, '장미', '빨간색', 1000);
...
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '해바라기', '노란색', 2000);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '국화', '하얀색', 1500);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '제비꽃', '보라색', 1800);
...
SELECT ID, NAME, AGE, PHONE FROM TBL_OWNER;

INSERT INTO TBL_OWNER
VALUES(SEQ_PRODUCT.NEXTVAL, '정지수', 28, '010-5253-7140');
INSERT INTO TBL_OWNER
VALUES(SEQ_PRODUCT.NEXTVAL, '정진욱', 31, '010-5253-7141');
INSERT INTO TBL_OWNER
VALUES(SEQ_PRODUCT.NEXTVAL, '전남숙', 40, '010-5253-7142');
INSERT INTO TBL_OWNER
VALUES(SEQ_PRODUCT.NEXTVAL, '정승모', 50, '010-5253-7143');
INSERT INTO TBL_OWNER
VALUES(SEQ_PRODUCT.NEXTVAL, '윤정현', 28, '010-5253-7144');

SELECT ID, NAME, AGE, PHONE FROM TBL_OWNER;

INSERT INTO TBL_OWNER(ID, NAME, PHONE)
VALUES(SEQ_PRODUCT.NEXTVAL, '주안나', '010-3333-4444');
INSERT INTO TBL_OWNER(ID, NAME, PHONE)
VALUES(SEQ_PRODUCT.NEXTVAL, '정한결', '010-3333-4445');
INSERT INTO TBL_OWNER(ID, NAME, PHONE)
VALUES(SEQ_PRODUCT.NEXTVAL, '윤희진', '010-3333-4446');
...
UPDATE TBL_OWNER 
SET PHONE = '010-5253-7140'
WHERE PHONE = '010-5253-7141';
...
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '장미', '노랑' , 1000);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '민들레', '노랑' , 1100);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '국화', '하양' , 1500);
INSERT INTO TBL_FLOWER
VALUES(SEQ_FLOWER.NEXTVAL, '해바라기', '노랑' , 1000);
...
CREATE SEQUENCE SEQ_FLOWER_POT;
...
SELECT ID, COLOR, SHAPE FROM TBL_FLOWER_POT;

INSERT INTO TBL_FLOWER_POT(ID, COLOR, SHAPE)
VALUES(SEQ_ORDER.NEXTVAL, '빨강', '원형');
INSERT INTO TBL_FLOWER_POT(ID, COLOR, SHAPE)
...
/*
SELECT PET_NAME, PET_ILL_NAME, WEIGHT, OWNER_ID, TBL_OWNER.OWNER_NAME, TBL_OWNER.OWNER_PHONE
FROM TBL_OWNER JOIN TBL_PET 
ON TBL_OWNER.ID = TBL_PET.OWNER_ID AND TBL_OWNER.OWNER_NAME = '이순신';

SELECT PET_AGE, TBL_OWNER.OWNER_NAME, OWNER_ID, TBL_OWNER.OWNER_AGE, TBL_OWNER.OWNER_PHONE, TBL_OWNER.OWNER_ADDRESS
FROM TBL_OWNER JOIN TBL_PET 
ON TBL_OWNER.ID = TBL_PET.OWNER_ID AND PET_AGE > 5;


SELECT PET_NAME, PET_ILL_NAME, TBL_OWNER.OWNER_NAME 
FROM TBL_OWNER JOIN TBL_PET 
...
/*//'띄어쓰기'를 해야 하거나 '키워드'와 같은 내용을 써야 한다면 ""을 써서 그 안에 써야 한다.*/
...
/*지수*******************************************************************/
/*SELECT 
   P.PET_NAME, O.ID "주인 번호", O.OWNER_NAME, O.OWNER_AGE, 
   O.OWNER_PHONE, O.OWNER_ADDRESS  
FROM TBL_OWNER O JOIN TBL_PET P
...
INSERT INTO TBL_PARENT
(ID, PARENT_NAME, PARENT_ADDRESS, PARENT_PHONE)
VALUES(SEQ_PARENT.NEXTVAL, '정지수', '하남시', '01052537140');
...
SELECT ROUND(AVG(CHILD_AGE), 2) AS "아이들 평균나이" FROM TBL_CHILD
GROUP BY PARENT_ID; */
...
/*SELECT ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID
FROM TBL_CHILD;

SELECT ID, PARENT_NAME, PARENT_ADDRESS, PARENT_PHONE, PARENT_GENDER
FROM TBL_PARENT;
...
/*각 유치원들의 체험학습 진행 건수*/
/*SELECT AVG(COUNT(C.ID)) FROM TBL_CHILD C
JOIN TBL_PARENT P
ON C.ID = P.ID
GROUP BY PARENT_ID;

TBL_APPLY - FIELD_TRIP_ID - KINDERGARTEN


FROM TBL_FIELD_TRIP F JOIN TBL_APPRY A
...
/*각 유치원들의 체험학습 진행 건수 */
SELECT F.KINDERGARTEN_ID, COUNT(F.ID) 
FROM TBL_KINDERGARTEN K JOIN TBL_FIELD_TRIP F
ON K.ID = F.KINDERGARTEN_ID 
GROUP BY K.ID; 

/*각 유치원들의 체험학습 지원 건수 */
SELECT F.KINDERGARTEN_ID, COUNT(A.FIELD_TRIP_ID) 
FROM TBL_FIELD_TRIP F JOIN TBL_APPLY A
ON F.ID = A.FIELD_TRIP_ID 
/*INNER JOIN: 조건에 일치하는 값만 합쳐서 조회
 *ON과 무조건 같이 사용해야 함. ON은 WHERE, HAVING과 같은
 *조건식 절 키워드... 체험학습 테이블에 신청(지원) 테이블을 JOIN
 *신청(지원) 테이블에 체험학습 테이블 FK로 되어있음. 
 *체험학습 ID 번호와 신청(지원) 테이블 내 FK로 선언된 체험학습 ID 번호와 같니? 그러면
 *신청(지원) 테이블과 체험학습 테이블을 조인해라. */
GROUP BY F.KINDERGARTEN_ID; 
...
VALUES(SEQ_MEMBER.NEXTVAL, 'jisoo000', 'chlrht21#', '정지수', '하남시', 
							'000jisoo@gmail.com', TO_DATE('2000-07-21', 'YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'jiwook1201', 'wlsdnr01', '정진욱', '하남시', 
							'jiwook1201@gmail.com', TO_DATE('1994-12-01', 'YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'hanguel7', 'gksruf7#', '정한결', '서울시', 
							'hanguel7@gmail.com', TO_DATE('1996-05-21', 'YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'hanna316', 'hanna21#', '이한나', '양평시', 
							'hanna316@gmail.com', TO_DATE('1990-07-03', 'YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'anna0601', 'dkssk0601#', '주안나', '서울시', 
							'anna0601@gmail.com', TO_DATE('1995-03-06', 'YYYY-MM-DD'));
INSERT INTO TBL_MEMBER
(ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH)
VALUES(SEQ_MEMBER.NEXTVAL, 'mingi0601', 'alswl0601#', '강민지', '서울시', 
							'mingi0601@gmail.com', TO_DATE('1992-03-16', 'YYYY-MM-DD'));
...
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 5, 3);
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 5, 3);
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 5, 1);
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 3, 5);
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 3, 1);
INSERT INTO TBL_LIKE
(ID, LIKE_RECEIVER, LIKE_SENDER)
VALUES(SEQ_LIKE.NEXTVAL, 5, 7);
...
/*지수(확인필요)*/
/*SELECT M.MEMBER_NAME, COUNT(L.LIKE_RECEIVER)
FROM TBL_MEMBER M JOIN TBL_LIKE L
ON M.ID = L.LIKE_RECEIVER
GROUP BY L.LIKE_RECEIVER, M.MEMBER_NAME;*/
...
INSERT INTO TBL_USER
VALUES(SEQ_USER.NEXTVAL, 'lss1111', '1111', '경기도 남양시', 'lss1111@gmail.com', '1999-01-05');
...
INSERT INTO TBL_POST(ID, POST_TITLE, POST_CONTENT, USER_ID)
VALUES(SEQ_POST.NEXTVAL, '테스트 제목2', '테스트 내용2', 2);
INSERT INTO TBL_POST(ID, POST_TITLE, POST_CONTENT, USER_ID)
...
INSERT INTO TBL_REPLY
VALUES(SEQ_REPLY.NEXTVAL, '댓글 테스트1', 1, 5);
...
CREATE TABLE TBL_MEMBERS(
   ...
   MEMBERS_NAME VARCHAR2(255) NOT NULL
);
...
CREATE TABLE TBL_POST(
   ...
   POST_TITLE VARCHAR2(255) NOT NULL,
   MEMBERS_ID NUMBER,
   CONSTRAINT FK_POST_MEMBERS FOREIGN KEY(MEMBERS_ID)
   REFERENCES TBL_MEMBERS(ID)
);

INSERT INTO TBL_MEMBERS
(ID, MEMBERS_NAME)
VALUES(SEQ_MEMBERS.NEXTVAL, '한동석');
INSERT INTO TBL_MEMBERS
(ID, MEMBERS_NAME)
VALUES(SEQ_MEMBERS.NEXTVAL, '홍길동');
...
(ID, POST_TITLE, MEMBERS_ID)
VALUES(SEQ_POST.NEXTVAL, 'TEST01', 1);

SELECT * FROM TBL_POST;

/*회원별 게시글 작성 수 조회하기*/
SELECT * 
FROM TBL_MEMBERS M1 JOIN 
(
   SELECT M.ID, COUNT(P.ID) 
   FROM TBL_MEMBERS M LEFT OUTER JOIN TBL_POST P
...
/*체험학습을 2개 이상 신청한 부모의 아이 정보 조회(단, 아이가 없는 부모의 정보는 모두 나와야한다)*/

SELECT ID, KINDERGARTEN_NAME, KINDERGARTEN_ADDRESS
FROM TBL_KINDERGARTEN;
SELECT ID, PARENT_NAME, PARENT_ADDRESS, PARENT_PHONE, PARENT_GENDER
FROM TBL_PARENT;
SELECT ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID
FROM TBL_CHILD;
SELECT ID, FIELD_TRIP_TITLE, FIELD_TRIP_CONTENT, KINDERGARTEN_ID
FROM TBL_FIELD_TRIP;
SELECT ID, FILE_NAME, FILE_PATH, FILE_SIZE
FROM TBL_FILE;
SELECT ID, FIELD_TRIP_ID
FROM TBL_FIELD_TRIP_FILE;
SELECT ID, MEMBER_ID, MEMBER_PASSWORD, MEMBER_NAME, MEMBER_ADDRESS, MEMBER_EMAIL, MEMBER_BIRTH, KINDERGARTEN_ID
FROM TBL_MEMBER;
SELECT ID, PARENT_ID, FIELD_TRIP_ID
FROM TBL_APPLY;
...
FROM JOIN 
( 
   SELECT P.ID "부모 번호", C.ID "아이들 번호"
   FROM TBL_CHILD C LEFT OUTER JOIN TBL_PARENT P
   ON C.ID = C.PARENT_ID 
   GROUP BY P.ID, C.ID 
) */


/*회원별 게시글 작성 수 조회하기**강사*확인용*/
/*SELECT 
FROM TBL_MEMBERS M1 JOIN 
(
   SELECT M.ID, COUNT(P.ID) 
...
LEFT OUTER JOIN
(
   SELECT FIELD_TRIP_ID, MIN(PARENT_ID)
   FROM TBL_APPLY LEFT OUTER JOIN TBL_FIELD_TRIP 
   ON 
   GROUP BY FIELD_TRIP_ID
   HAVING MIN(PARENT_ID) 
) P2
ON P1.ID = P2.PARENT_ID;*/
/***********************************************************/
...
/*평균 신청자 수 - AVG(COUNT(TBL_APPLY.PARENT_ID))
평균 신청자 수보다 적은 체험학습 
체험학습의 제목과 내용 조희


WHRER TBL_APPLY.FIELD_TRIP_ID <

SELECT AVG(COUNT(TBL_APPLY.PARENT_ID))
FROM TBL_APPLY
GROUP BY PARENT_ID
HAVING 
